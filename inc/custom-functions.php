...
function rara_academic_get_social_links(){
    ...
    $odnoklassniki  = get_theme_mod( 'rara_academic_odnoklassniki' );
    $youtube   = get_theme_mod( 'rara_academic_youtube' );
    
    if( $facebook || $vkontakte || $twitter || $gplus || $instagram || $odnoklassniki || $youtube ){
    ?>
    <ul class="social-networks">
        ...
        <?php } if( $vkontakte ){ ?>
        <li><a href="<?php echo esc_url( $vkontakte ); ?>" class="fa fa-vk" target="_blank" title="<?php esc_attr_e( 'ВКонтакте', 'rara-academic' );?>"></a></li>
        <?php } if( $twitter ){ ?>
        ...
        <li><a href="<?php echo esc_url( $odnoklassniki ); ?>" class="fa fa-odnoklassniki" target="_blank" title="<?php esc_attr_e( 'Одноклассники', 'rara-academic' );?>"></a></li>
        <?php } if( $youtube ){ ?>

                ...
                <div class="desk">
                    <div id="header-one">
                        <?php 
					        ...
					        echo '<p>г. Москва, ул. Красная Пресня, д. 9</p>';
                    ...
                    <div id="header-three">
                        <?php 
                            ...
                            echo '<label title="Контактная форма в модальном окне" class="btn" for="modal-2">Записаться на курсы</label>';
...
<div class="modal">
  ...
  <div class="modal-wrap" aria-hidden="true" role="dialog">
    ...
    <div class="modal-dialog" id="tdblock">
      <div class="modal-header">
        <h2>Форма записи на курсы</h2>
        <label class="btn-close" for="modal-2" aria-hidden="true">×</label>
      </div>
      <div class="modal-body">
          <p>Дорогие друзья! Для записи на актерские курсы или на актерский тренинг в Москве звоните, пожалуйста, по тел. <a href="tel:+79251356410">+7 925 135-64-10</a> (с 12:00 до 21:00) или просто оставьте свои контактные данные и мы Вам перезвоним!</p>
          <div><br>
              <?php echo do_shortcode( '[contact-form-7 id="272" title="Форма записи"]' ); ?>
          </div>
      </div>
    </div>
  </div>
	...
	function rara_academic_main_header(){
        ...
        if( ! is_page_template('template-home.php') ){
            ...
            if( $ed_bc ){?>
                ...
                <div id="page-header-title"><h1><?php single_post_title() ?></h1></div>
...
*/
	function rara_academic_content_end(){
	    ...
	    ?>
                    ...
                    <a href="http://artmaster.info/workshops" id="block-link"><span>Смотреть все мастер-классы</span></a>
		        </div><!-- .container -->
		    </div><!-- #content -->
    ...
    ?>
			<div class="container">
                ...
                <div class="desk">
                    ...
                    <div id="ft-two">
                            <p>Created &amp; promoted by <a href="http://reisgn.com" target="_blank">Reisgn</a></p>
                    </div>
                    <div id="ft-three">
                        <?php 
	                        $phone     = get_theme_mod( 'rara_academic_phone' );
